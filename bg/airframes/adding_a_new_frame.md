...
When you introduce a new airframe group like "Plane V-Tail" with a new image like "PlaneVTail.svg", then this image will be shown via
...
The files are generated via a botscript from the airframe description which is located at [ROMFS/px4fmu_common/init.d](https://github.com/PX4/Firmware/tree/master/ROMFS/px4fmu_common/init.d), but the image itself has to be checked in at each repository.
