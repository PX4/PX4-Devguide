...
**Careful**: some of the data is accessed and modified from both threads, so when changing code or extending the
functionality, this needs to be taken into account, in order to avoid race conditions and corrupt data.
