...
- `-b`: Baud rate (optional) if the driver supports multiple baud rates. 
  ...
  > **Tip** See the [gps driver](https://github.com/PX4/Firmware/blob/master/src/drivers/gps/gps.cpp#L1023) for an example.
     ...
     serial_config:
         - command: ulanding_radar start -d ${SERIAL_DEV} -b p:${BAUD_PARAM}
           port_config_param:
             ...
             group: Sensors
     ```
   > **Note** The full documentation of the module configuration file can be found in the [validation/module_schema.yaml](https://github.com/PX4/Firmware/blob/master/validation/module_schema.yaml) file.
