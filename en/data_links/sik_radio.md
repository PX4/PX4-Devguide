...
* Mac OS X users must also install *XCode Command Line Tools*, and the [*Homebrew*](https://brew.sh/) package manager.
...
1. Build the image for the standard SiK Radio / 3DR Radio:
   ```sh
