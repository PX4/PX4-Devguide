...
A set of paramters need to be set in order for EKF2 to use the external position estimation. You can use QGroundContorl (QGC) to easilt adjust theses paramters. All of the following paramters can be found in the EKF2 tab in QGC.
